  ...
  (e.fn.cycle = function (i) {
    ...
    return 0 !== this.length || e.isReady
      ? this.each(function () {
          ...
          if (!l.data("cycle.opts")) {
            for (var r in ((!1 === l.data("cycle-log") ||
              (i && !1 === i.log) ||
              (s && !1 === s.log)) &&
              (a = e.noop),
            a("--c2 init--"),
            (n = l.data())))
              n.hasOwnProperty(r) &&
                ...
                ((c = n[r]),
                a(
                  (o = r.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, t)) + ":",
                  c,
                  "(" + typeof c + ")"
                ),
                (n[o] = c));
            ((s = e.extend({}, e.fn.cycle.defaults, n, i || {})).timeoutId = 0),
              (s.paused = s.paused || !1),
              (s.container = l),
              (s._maxZ = s.maxZ),
    ...
    (e.fn.cycle.API = {
      ...
      preInitSlideshow: function () {
        ...
        i && "function" == typeof i.preInit && i.preInit(t),
          (t._preInitialized = !0);
      },
      postInitSlideshow: function () {
        ...
        var i = e.fn.cycle.transitions[t.fx];
        i && "function" == typeof i.postInit && i.postInit(t);
      },
        ...
        "string" == typeof t && (t = t.trim()),
          e(t).each(function (t) {
            ...
            i ? s.container.prepend(o) : s.container.append(o),
              ...
              (s.slides = i ? e(o).add(s.slides) : s.slides.add(o)),
      ...
      queueTransition: function (t, i) {
        ...
        return 0 === n.nextSlide && 0 == --n.loop
          ...
          : void 0 !== n.continueAuto &&
            (!1 === n.continueAuto ||
              ("function" == typeof n.continueAuto && !1 === n.continueAuto()))
      ...
      stackSlides: function (t, i, n) {
        ...
        var c = o.maxZ - 2,
          l = o.slideCount;
        if (n) {
          for (s = o.currSlide + 1; s < l; s++)
            e(o.slides[s]).css("zIndex", c--);
          for (s = 0; s < o.currSlide; s++) e(o.slides[s]).css("zIndex", c--);
        } else {
  ...
  (function (e) {
    ...
    function t(t, i) {
      var n,
        ...
        c = i.autoHeight;
      if ("container" == c)
        (s = e(i.slides[i.currSlide]).outerHeight()), i.container.height(s);
      else if (i._autoHeightRatio)
        i.container.height(i.container.width() / i._autoHeightRatio);
      else if ("calc" === c || ("number" == typeof c && c >= 0)) {
        if (
          (o =
            "calc" === c
              ? (function (t, i) {
    ...
    function n(s, o) {
      o._autoHeightOnResize &&
        ...
        o.container.off("cycle-destroyed", n),
        o.container.off("cycle-before", i),
    ...
    e.extend(e.fn.cycle.defaults, {
      ...
      e(document).on("cycle-initialized", function (s, o) {
        ...
        ("string" !== a && "number" !== a) ||
          ...
          o.container.on("cycle-destroyed", n),
          "container" == l
            ? o.container.on("cycle-before", i)
            : "string" === a &&
              /\d+\:\d+/.test(l) &&
              ((c = (c = l.match(/(\d+)\:(\d+)/))[1] / c[2]),
              (o._autoHeightRatio = c)),
          "number" !== a &&
            ((o._autoHeightOnResize = function () {
              clearTimeout(r), (r = setTimeout(d, 50));
            }),
  ...
  (function (e) {
    ...
    (e.fn.cycle = function (i) {
      ...
      return "number" == typeof i
        ...
        ? this.each(function () {
            var l;
            if (((n = i), void 0 !== (o = e(this).data("cycle.opts"))))
              return (
                (n = "goto" == n ? "jump" : n),
                "function" == typeof (s = o.API[n])
                  ? ((l = e.makeArray(c)).shift(), s.apply(o.API, l))
      ...
      e.extend(t.API, {
        ...
        destroy: function () {
          this.stop();
          var t = this.opts(),
            i = "function" == typeof e._data ? e._data : e.noop;
          clearTimeout(t.timeoutId),
            (t.timeoutId = 0),
            t.API.stop(),
      ...
      e(document).on("cycle-pre-initialize", function (t, i) {
        if (i.progressive) {
          var n,
            ...
            l = o.prev,
            a = o.prepareTx,
            r = typeof i.progressive;
          if ("array" == r) n = i.progressive;
          else if ("function" == typeof i.progressive) n = i.progressive(i);
          else if ("string" == r) {
            if (((s = e(i.progressive)), !(n = s.html().trim()))) return;
            if (/^(\[)/.test(n))
              try {
                n = e.parseJSON(n);
              } catch (e) {
          ...
          return (
            ...
            t.replace(n, function (e, t) {
              ...
              for (i = 0; i < s.length; i++)
                if ((o = s[i])) {
                  if (l.length > 1)
                    for (c = o, n = 0; n < l.length; n++)
                      (o = c), (c = c[l[n]] || t);
                  else c = o[t];
                  if ("function" == typeof c) return c.apply(o, s);
                  if (null != c && c != t) return c;
                }
              return t;
            })
          );
