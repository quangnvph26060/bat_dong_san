                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" value="{{ old('title', $news->title) }}"
                                    placeholder="Nhập tiêu đề..." name="title" class="form-control" id="title">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="seo_description" cols="30" rows="5" class="form-control" placeholder="Seo description">{{ old('seo_description', $news->seo_description) }}</textarea>
...
@push('scripts')
    ...
    <script>
        ...
        $('#myForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.news.update', ['id' => $news->id]) }}",
                method: 'POST',
                data: data,
                contentType: false,
                processData: false,
